...
export const NUTRITION = {
  ...
  /* ====================================================================== */
  cafeine: [
    { n: 1, ou: "Départ Champex", quand: "~19:45", pourquoi: "Avant la nuit, avant Bovine" },
    { n: 2, ou: "Trient", quand: "~23:00", pourquoi: "Le point bas prévu" },
    { n: 3, ou: "Vallorcine", quand: "~01:45", pourquoi: "Avant la Tête aux Vents" },
    { n: "R", ou: "Réserve ×2", quand: "coup de mou imprévu", pourquoi: "⛔ JAMAIS avant Champex — elle ne marche que si tu ne l'as pas gaspillée de jour" }
  ],
  cafeineMgParGel: null, // a saisir apres TraKKs (lundi 17)
