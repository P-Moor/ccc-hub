...
export const VERDICT_CHAUSSURES = {
  ...
  redondanceChaussettes: "Les Sidas Trail Protect étaient au lavage le 19 : le test s'est fait en BV Sport. Ce n'est donc pas une validation des Sidas, mais ça prouve que les BV Sport tiennent aussi, et en humide. Deux systèmes qui fonctionnent, c'est de la redondance, pas une hésitation."
};
...
export const TROUSSE = {
  ...
  suivi: {
    priseDeSang: "faite le 20/08, résultats en attente. Sans incidence sur la course.",
...
export const VESTE = {
  ...
  probleme: "Ne déperle plus. Constaté le 19/08 : trempé de l'intérieur, surtout aux avant-bras.",
  ...
  produit: "Nikwax Tech Wash + TX.Direct — commandé le 19/08, livraison 20-21/08 en point relais",
  protocole: [
    ...
    { n: 4, txt: "Chaleur douce : sèche-linge basse température 20 min, ou fer doux avec un linge entre les deux. Le déperlant s'active à la chaleur." },
...
export const LAMPES = {
  ...
  secours: {
    modele: "Petzl Aria 1R RGB", alimentation: "piles AAA",
    modeRouge: "vérifié le 14/08"
  },
  rechange: [
    { objet: "Batterie de rechange Swift RL", statut: "commandée le 19/08",
      note: "Pierre préfère avoir deux fois la RL plutôt que dépendre de l'Aria." },
    { objet: "Piles AAA de rechange", statut: "à acheter", pour: "Aria 1R" }
  ],
  reglementaire: "2 lampes + rechange pour chacune : la ligne du règlement est cochée",
  froid: "🌡️ Le froid tue les batteries. Garder la Swift allumée sur la tête, elle reste au chaud. Si tu la retires : poche intérieure, contre le corps."
};
...
export const MENUS = {
  principe: [
    ...
    "Les fibres baissent progressivement à partir du jeudi 27",
  ...
  jours: [
    {
      date: "2026-08-25", label: "Mardi 25 · J-3", sous: "la recharge démarre · nuit à l'hôtel",
      repas: [
        { moment: "Petit-déj", contenu: "Porridge d'avoine · banane · miel · un peu de skyr" },
    ...
    {
      date: "2026-08-26", label: "Mercredi 26 · J-2", sous: "10 h de trajet",
    ...
    {
      date: "2026-08-27", label: "Jeudi 27 · J-1", sous: "pic glucidique, fibres réduites",
      repas: [
...
export const PHYSIO = {
  ...
  charge: "ACWR 0,8 OPTIMAL · TSB +108 · MAINTAINING",
